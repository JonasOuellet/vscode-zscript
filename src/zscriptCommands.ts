   ...
   { syntax: '[%s, %s]',
     ...
     args: 
      [ { name: 'name', type: ZArgType.routine,
        ...
        { name: 'inputVar01', description: 'Input Var01', type: ZArgType.string },
        { name: 'inputVar02', description: 'Input Var02', type: ZArgType.string },
        { name: 'inputVar03', description: 'Input Var03', type: ZArgType.string },
        { name: 'inputVar04', description: 'Input Var04', type: ZArgType.string },
        { name: 'inputVar05', description: 'Input Var05', type: ZArgType.string },
        { name: 'inputVar06', description: 'Input Var06', type: ZArgType.string },
        { name: 'inputVar07', description: 'Input Var07', type: ZArgType.string },
        { name: 'inputVar08', description: 'Input Var08', type: ZArgType.string },
        { name: 'inputVar09', description: 'Input Var09', type: ZArgType.string },
        { name: 'inputVar10', description: 'Input Var10', type: ZArgType.string } ],
     level: ZScriptLevel.all,
     return: ZArgType.null },
  RoutineDef: 
   { syntax: '[%s, %s]',
     ...
     args: 
      [ { name: 'name', description: 'Name of the routine', type: ZArgType.string },
        { name: 'commands', type: ZArgType.commandGroup,
